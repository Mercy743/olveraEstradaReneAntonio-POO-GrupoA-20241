...
public class Cliente extends Usuario {
    ...
    public Cliente(String nombre, String apellido, String contraseña, String nombreUsuario, String numeroTelefono, LocalDate fechaNacimiento) {
        super(nombre, apellido, Rol.CLIENTE, contraseña, nombreUsuario, numeroTelefono, fechaNacimiento);
