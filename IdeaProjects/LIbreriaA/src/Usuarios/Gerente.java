...
public class Gerente extends Usuario implements EmpleadosUtils {
    ...
    public Gerente(String nombre, String apellidos, String nombreUsuario, String contraseña, double sueldo, String numeroTelefono, LocalDate fechaNacimiento) {
        super(nombre, apellidos, Rol.GERENTE, nombreUsuario, contraseña, numeroTelefono, fechaNacimiento);
        this.sueldo = sueldo;
    }
    ...
    public static void registrarGerente(){
        ...
        Gerente gerente = new Gerente(nombre, apellidos, nombreUsuario, telefono, sueldo, contraseña, fechaNacimiento);
